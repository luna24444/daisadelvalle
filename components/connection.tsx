      ...
      <div className="mx-auto max-w-4xl px-5 text-center md:px-8">
        <Reveal>
          <span className="text-[11px] uppercase tracking-widest-plus text-primary">
            Direito da Família e Previdenciário.
          </span>
        </Reveal>
        <Reveal delay={80}>
        ...
        <Reveal delay={160}>
          <div className="mx-auto mt-8 max-w-2xl space-y-4 text-base leading-relaxed text-muted-foreground md:text-lg">
            <p>
Separação, guarda, pensão e outras questões familiares. Dúvidas sobre aposentadoria, benefícios previdenciários ou BPC/LOAS.            </p>
            <p>
